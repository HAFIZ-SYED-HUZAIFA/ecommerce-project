...
const saleproductData = [
  ...
  return (
    <div>
      ...
      {/* parent div for 3 blog */}
      {/* <div className='flex flex-col items-center justify-center'>
      {blogData.map((blog, index) => (
      <div key={index} className='flex gap-7 flex-col'>
      <Image src={blog.imageSrc} alt="blog" width={870} height={453} className='rounded-[6px]'></Image>
      <div className='flex gap-10'>
      <div className='flex gap-2'>
      <Image src="/blog/Vector (2).png" alt="icon" width={1000} height={1000} className='w-3 h-3 mt-[6px]'></Image>
      <span className='w-[160px] h-[23px] bg-[#FFECE2] text-center font-normal font-josefin text-[14px] text-[#151875]'>Surf Auxion</span>
      </div>
      <div className='flex gap-2'>
      <Image src="/blog/uil_calendar-alt.png" alt="calendar icon" width={1000} height={1000} className='w-3 h-3 mt-[6px]'></Image>
      <span className='w-[127px] h-[23px] bg-[#FFECE2] text-center font-lato text-[14px] font-semibold text-[#151875]'>Aug 09 2020</span>
      </div>
      </div>
      <h2 className='text-[#151875] font-josefin text-[30px] leading-[35.16px] font-bold'>{blog.title}</h2>
      <p className='w-[854px] h-[49px] text-[16px] font-lato font-normal leading-[25.6px] text-[#8A8FB9]'>{blog.paragraph}</p>
      <p className='flex gap-1 text-[#151875] font-lato font-semibold text-[18px] mb-10'>Read More<span className='w-[5px] h-[5px] bg-[#FB2E86] rounded-full mt-3'></span></p>
      </div>
      ))}
      </div> */}
      <div className="flex flex-col items-center justify-center">
