...
const shoplist = [
  ...
  return (
    ...
    {/* parent div below shoplist section */}
    {/* <div className='flex flex-col items-center justify-center mt-28'>
    <div className='w-[1171px] h-[44px] flex items-center justify-between below-1200:flex-col below-1200:w-auto below-1200:h-auto'> */}
    {/* left section */}
    {/* <div className='flex flex-col gap-1'>
    <h2 className='font-josefin text-[#151875] text-[22px] font-bold'>Ecommerce Acceories & Fashion item </h2>
    <p className='font-lato font-normal text-[#8A8FB9] text-[12px]'>About 9,620 results (0.62 seconds)</p>
    </div> */}
    {/* right section */}
    {/* <div className='flex gap-6'>
    <div className='flex gap-2'>
    <label htmlFor="per-page-input" className='text-[16px] font-lato font-normal text-[#3F509E]'>Per Page:</label>
    <input type="text" id="per-page-input" className="w-[55px] h-[25px] border-[1px] border-[#E7E6EF] focus:outline-none rounded-[2px]"/>
    </div>
    <div className='flex gap-2'>
    <span className='text-[16px] font-lato font-normal text-[#3F509E]'>Sort By:</span>
    <div className='w-[96px] h-[28px] border-[1px] border-[#E7E6EF] rounded-[2px]'>
    <p className='font-lato font-normal text-[#8A8FB9] text-[12px] relative top-1 left-[6px]'>Best Match</p>
    <Image src="/shop/akar-icons_chevron-down.png" alt="dropdown" width={12} height={12} className='relative left-[68px] top-[-12px]'></Image>
    </div>
    </div>
    <div className='flex gap-1'>
    <label htmlFor="per-view-input" className='text-[16px] font-lato font-normal text-[#3F509E]'>View:</label>
    <IoGrid className='w-[12px] h-[12px] relative top-[7px] text-[#151875]'/>
    <FaList className='w-[12px] h-[12px] relative top-[7px] text-[#151875]'/>
    <input type="text" id="per-view-input" className="w-[162px] h-[30px] border-[1px] relative left-4 border-[#E7E6EF] focus:outline-none rounded-[2px]"/>
    </div>
    </div>
    </div> */}

    {/* parent div for multiple carts */}
    {/* <div className='flex flex-col items-center justify-center gap-10 mt-20 below-1200:gap-[250px]'>
    {shoplist.map((shop,index) => (
    <div key={index} className='flex gap-6 w-[1141px] h-[251px] items-center below-1200:flex-col below-1200:text-center'>
    <Image src={shop.imageSrc} alt='shopitem' width={313.63} height={217.56}></Image>
    <div className='flex flex-col gap-3 below-1200:items-center below-1200:justify-center'>
    ...
    <div>
    <span className='text-[#111C85] text-[15.46px] flex gap-3 font-josefin'>$26.00<span className='text-[#FF2AAA] text-[15.46px] line-through font-josefin'>$52.00</span></span> 
    </div>
    <p className='font-lato font-normal text-[17.67px] text-[#9295AA] leading-[30.92px] w-[560px] below-1200:w-[300px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Magna in est adipiscing in phasellus non in justo.</p>
